...
if ( ! defined( 'MID_LOCALE' ) )
	define( 'MID_LOCALE', '' );
	
if ( ! defined( 'MID_DIR' ) )
	define( 'MID_DIR', get_template_directory().'/inc/settings-panel' );

if ( ! defined( 'MID_URL' ) )
	define( 'MID_URL', get_template_directory_uri().'/inc/settings-panel' );
...
function twentyfifteen_setup() {
	...
	add_image_size( 'prop-small', 1200, 810, true );
...
require_once( get_template_directory() . '/inc/post-properties.php' );
require_once( get_template_directory() . '/inc/post-principals.php' );
require_once( get_template_directory() . '/inc/post-hero.php' );
...
add_action('wp_ajax_nopriv_mid_submit', '_midAjaxSubmit');
add_action('wp_ajax_mid_submit', '_midAjaxSubmit');
function _midAjaxSubmit(){
	$nonce = $_REQUEST['nonce'];	
	if(!wp_verify_nonce($nonce, 'mid_post_submit')){
	...
	?>
		...
		<HTML>
		<HEAD><TITLE>Midway Investors Inc</TITLE></HEAD>
	...
	ob_end_clean();
	$mid_settings = get_option('mid_options');
	$form_email = $mid_settings['mid_email'];
	if($form_email){
