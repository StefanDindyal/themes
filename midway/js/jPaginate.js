    ...
    $.fn.jPaginate = function(options) {
        ...
        return this.each(function() {
            ...
            function createPagination(curr) {
				...
				var previous_inactive = "<li><a class='inactive goto_previous' href='#'>"+options.previous+"</a></li>";
                var next_inactive = "<li><a class='inactive goto_next' href='#'>"+options.next+"</a></li>";
                end = "</ul>"
