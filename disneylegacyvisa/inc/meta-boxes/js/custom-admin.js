...
$('#landing-page, #rg-discography, #rg-discography-slider, #rg-discography-list').show();
...
if($('input[type="checkbox"]#cri_enable').is(':checked')){
$('tr#cri_which_slider').show();
}
$('input[type="checkbox"]#cri_enable').on('click', function(){
if($(this).is(':checked')){
$('tr#cri_which_slider').show();
} else {
$('tr#cri_which_slider').hide();
$('tr#cri_which_slider .meta_box_items input[type="radio"]').prop('checked', false);
}
});
