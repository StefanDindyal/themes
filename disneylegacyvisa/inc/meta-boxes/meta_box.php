<?php
//include( get_template_directory() . '/inc/meta-boxes/meta_box.php' ); ADD TO YOU FUNCTIONS.PHP
// metaboxes directory constant
define( 'CUSTOM_METABOXES_DIR', get_template_directory_uri().'/inc/meta-boxes' );
	...
	function admin_enqueue_scripts() {
		...
		if ( in_array( $pagenow, array( 'post-new.php', 'post.php' ) ) && in_array( get_post_type(), $this->page ) ) {
			...
			if ( in_array( true, array(
				...
				wp_register_script( 'chosen', get_template_directory_uri(). '/inc/meta-boxes/js/chosen.js', array( 'jquery' ) );
				$deps[] = 'chosen';
				wp_enqueue_style( 'chosen', get_template_directory_uri(). '/inc/meta-boxes/css/chosen.css' );
			}
			if ( in_array( true, array( 
				...
				wp_enqueue_script( 'farb', get_template_directory_uri(). '/inc/meta-boxes/js/farbtastic.js', $deps );
				wp_enqueue_script( 'meta_box', get_template_directory_uri(). '/inc/meta-boxes/js/custom-admin.js', $deps );
			
			// css
			$deps = array();
			wp_register_style( 'jqueryui', get_template_directory_uri(). '/inc/meta-boxes/css/jqueryui.css' );
			if ( meta_box_find_field_type( 'date', $this->fields ) || meta_box_find_field_type( 'slider', $this->fields ) )
				$deps[] = 'jqueryui';
			if ( meta_box_find_field_type( 'color', $this->fields ) )
				$deps[] = 'farbtastic';
			wp_enqueue_style( 'farbtastic', get_template_directory_uri(). '/inc/meta-boxes/css/farb.css', $deps );
			wp_enqueue_style( 'meta_box', get_template_directory_uri(). '/inc/meta-boxes/css/meta_box.css', $deps );
		}
	}
